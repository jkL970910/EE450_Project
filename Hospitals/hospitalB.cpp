...
class Hospital {
    ...
    void findLocationScore(int location) {
        ...
        if (hospitalScore[1] > 0) {
            ...
            fprintf(stderr, "Hospital B has the score = None\n");
        }
    }
};
...
class SchedulerMain {
    ...
    void connectScheduler(Hospital& hospital) {
        ...
        while (1) {
            ...
            if (hospitalScore[1] == -2) fprintf(stderr, "Hospital B has sent 'location not found' to the Scheduler\n");
            else if (hospitalScore[1] == -1) fprintf(stderr, "Hospital B has sent score = None and distance = None to the Scheduler\n");
